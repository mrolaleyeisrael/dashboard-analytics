...
const Profile = () => {
  ...
  const { profileMenu, toggleProfileMenu } = useStore() as StoreState;


  const { theme } = useTheme()
  return (
    <div onClick={toggleProfileMenu} className='md:px-2 pr-3 md:py-[6px] border dark:border-[#34CAA5]/50 flex items-center gap-2 rounded-full cursor-pointer  '>
